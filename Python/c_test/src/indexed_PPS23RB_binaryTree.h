...
#include "indexed_PPS23RB_binaryTree_node.h"
    ...
    IPPRBBT *ipps23rbbt_new(void)
    {
        ...
        tree->mNilSentinel = ipps23rbbt_new_node(0);
        if (!tree->mNilSentinel)
        {
            free(tree);
            return nullptr;
        }
        tree->mInOrderEnd = ipps23rbbt_new_node(0);
        if (!tree->mInOrderEnd)
        {
        ...
        tree->mRevInOrderEnd = ipps23rbbt_new_node(0);
    ...
    int ipps23rbbt_size(IPPRBBT *tree) { return tree->mSize; }
    ...
    void ipps23rbbt_insert_root_node(IPPRBBT *tree, int data)
    {
    ...
    void ipps23rbbt_insert_last_inorder_node(IPPRBBT *tree, int data)
    {
    ...
    void ipps23rbbt_insert_first_inorder_node(IPPRBBT *tree, int data)
    {
        IPPS23RBBTN *childNode = ipps23rbbt_new_node(data);
        if (!childNode)
        {
    ...
    void ipps23rbbt_insert_left_child(IPPRBBT *tree, IPPS23RBBTN *parentNode, int data)
    {
        IPPS23RBBTN *childNode = ipps23rbbt_new_node(data);
        if (!childNode)
        {
    ...
    void ipps23rbbt_insert_right_child(IPPRBBT *tree, IPPS23RBBTN *parentNode, int data)
    {
        IPPS23RBBTN *childNode = ipps23rbbt_new_node(data);
        if (!childNode)
        {
