...
if __name__ == "__main__":
    ...
    input_dir = "/home/sepehr/uni/DS/paper/EfficientLinearList/doc/insert/"  # Replace with your folder path
    output_pdf = "Insert_random_indices.pdf"  # Replace with desired output PDF path
